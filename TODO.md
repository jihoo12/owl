...
2. 🔴 **Omega (linear arithmetic)** — `by omega` landed (see §B.1); **Ring solver** landed (see §B.2, `by ring` over `Nat`) — Group/Field solvers are the remaining automation ladder.
