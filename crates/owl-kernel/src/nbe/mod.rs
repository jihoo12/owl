...
//! (`crate::{env, equality, driver, tactics, typechecker, ...}`)
//! keep importing from `crate::nbe::*` unchanged, and hosts the
...
#[allow(unused_imports)]
pub use crate::session::get_meta_solution;

use std::sync::{Arc, Mutex};

use crate::session::Session;
use crate::syntax::{Term, max_var};
